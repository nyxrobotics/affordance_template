#ifndef AFFORDANCE_TEMPLATE_PANEL_HPP
#define AFFORDANCE_TEMPLATE_PANEL_HPP
...
{
    class AffordanceTemplatePanel : public rviz::Panel
    {
    Q_OBJECT
    public:
        typedef boost::shared_ptr<Affordance> AffordanceSharedPtr;

        AffordanceTemplatePanel(QWidget* parent=0);
        ~AffordanceTemplatePanel();
